...
pub const LIBOBS_API_MAJOR_VER: u32 = 31;
...
pub type _tile1024i_1024a = [::std::os::raw::c_int; 256usize];
#[repr(C)]
#[repr(align(1024))]
...
pub type __m128bh_u = u128;
pub type __m256bh_u = __BindgenOpaqueArray<u8, 32usize>;
pub type __m512bh_u = __BindgenOpaqueArray<u8, 64usize>;
#[repr(C)]
#[repr(align(16))]
#[derive(Debug, Default, Copy, Clone, PartialOrd, Ord, PartialEq, Eq)]
...
pub type obs_canvas_flags = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, PartialOrd, Ord, PartialEq, Eq)]
...
unsafe extern "C" {
    ...
    pub fn obs_enum_canvases(
        enum_proc: ::std::option::Option<
            unsafe extern "C" fn(arg1: *mut ::std::os::raw::c_void, arg2: *mut obs_canvas_t) -> bool,
        >,
        param: *mut ::std::os::raw::c_void,
    );
    ...
    pub fn obs_encoder_set_preferred_color_space(encoder: *mut obs_encoder_t, colorspace: video_colorspace);
    pub fn obs_encoder_get_preferred_color_space(encoder: *const obs_encoder_t) -> video_colorspace;
    ...
    pub fn obs_encoder_video_tex_active(encoder: *const obs_encoder_t, format: video_format) -> bool;
    ...
    pub fn obs_canvas_set_channel(canvas: *mut obs_canvas_t, channel: u32, source: *mut obs_source_t);
    #[doc = " Gets the source currently in use for this view context"]
    pub fn obs_canvas_get_channel(canvas: *mut obs_canvas_t, channel: u32) -> *mut obs_source_t;
    #[doc = " Create scene attached to a canvas"]
    pub fn obs_canvas_scene_create(canvas: *mut obs_canvas_t, name: *const ::std::os::raw::c_char) -> *mut obs_scene_t;
    ...
    pub fn obs_canvas_get_video_info(canvas: *const obs_canvas_t, ovi: *mut obs_video_info) -> bool;
